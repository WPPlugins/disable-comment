...
if (!class_exists('WordPress_Disable_Comments')) {
     ...
     */
    class WordPress_Disable_Comments extends WSXDC_Module
    {
        ...
        protected function __construct()
        {
            ...
            $this->modules = array(
                'WSXDC_Settings' => WSXDC_Settings::get_instance()
            );
        }
        ...
        public static function load_resources()
        {
            wp_register_script(
                ...
                plugins_url('javascript/wsx-disable-comments.js', dirname(__FILE__)),
                array('jquery'),
                self::VERSION,
                true
            );
            ...
            wp_register_script(
                ...
                plugins_url('javascript/wsx-disable-comments-admin.js', dirname(__FILE__)),
                array('jquery'),
                self::VERSION,
                true
            );
        ...
        public function filter_get_comment_author_link( $author_link ){
            $disable_what = $this->modules['WSXDC_Settings']->settings['disablewhat'];
            if (isset($disable_what['disable-authorlink']) && $disable_what['disable-authorlink'] == 1) {
                $disable_where = $this->modules['WSXDC_Settings']->settings['disablewhere'];
        ...
        {
            try {
                $instance_example = new WSXDC_Instance_Class('Instance example', '42');
        ...
        {
            if (version_compare($this->modules['WSXDC_Settings']->settings['db-version'], self::VERSION, '==')) {
                return;
            }

            foreach ($this->modules as $module) {
                $module->upgrade($this->modules['WSXDC_Settings']->settings['db-version']);
            }

            $this->modules['WSXDC_Settings']->settings = array('db-version' => self::VERSION);
